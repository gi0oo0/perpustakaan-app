<x-guest-layout>
    ...
    <div class="mt-6 rounded-xl bg-white/[0.04] border border-white/10 p-4 sm:p-5">
        ...
        <div class="mt-3 space-y-2">
            ...
            <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center gap-2 font-body text-base text-sky-300 hover:text-sky-200 transition-colors">
