<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            {{-- Summary Banner --}}
            <div class="bg-lemon border-3 border-border shadow-neo p-8 relative overflow-hidden rounded-neo">
                ...
                <div class="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-4">
                    <div class="bg-white border-3 border-border shadow-neo-sm p-4 text-center rounded-neo-sm">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <a href="{{ route('books.index') }}" class="book-card neo-card text-center group">
                        <div class="w-14 h-14 bg-primary border-3 border-border shadow-neo-sm mx-auto flex items-center justify-center text-2xl mb-3 group-hover:shadow-neo-hover transition-all duration-150 rounded-neo">📖</div>
                    ...
                    <a href="{{ route('loans.borrow.create') }}" class="book-card neo-card text-center group">
                        <div class="w-14 h-14 bg-lemon border-3 border-border shadow-neo-sm mx-auto flex items-center justify-center text-2xl mb-3 group-hover:shadow-neo-hover transition-all duration-150 rounded-neo">📦</div>
                    ...
                    @if (Auth::user()->isStaff())
                        <a href="{{ route('loans.return.create') }}" class="book-card neo-card text-center group">
                            <div class="w-14 h-14 bg-coral border-3 border-border shadow-neo-sm mx-auto flex items-center justify-center text-2xl mb-3 group-hover:shadow-neo-hover transition-all duration-150 rounded-neo">🔄</div>
